...
<a href="goal.html" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Goal Planning</a>
                    <a href="expense.html" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Expense Tracker</a>
                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="container-fluid pt-4 px-4">
                                <div class="bg-secondary text-center rounded p-4">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table text-start align-middle table-bordered table-hover mb-0">
                                            ...
                                            <tbody>
                                            <form action="newsplit.php" method="post">
                                                <?php
                                                    $query = "SELECT * FROM `grp` where grpname='Group1'";
                                                    $query1 = "SELECT upi FROM `user` where email='$mail'";
                                                    ...
                                                    if(mysqli_num_rows($query_run) != 0)
                                                    {
                                                        ...
                                                        foreach($query_run as $items)
                                                        {
                                                            ...
                                                            ?>
                                                            <tr>
                                                            <td><input type="text" name="name1<?= $count;?>" id="name1" value="<?= $items['username']; ?>"></td>
                                                            <td><input type="text" name="name2<?= $count;?>" id="name2" value="<?= $items['email']; ?>"></td>
                                                            <td><input type="text" name="name3<?= $count;?>" id="name3"></td>
                                                            </tr>
                                                <?php
                                                        }
                                                    }                                
                                ...
                                <input type="text" name="name4" value="<?= $count; ?>" hidden>
                                <input type="text" name="name5" value="<?= $upi; ?>" hidden>
                                <button type="submit" name="submit" class="btn btn-sm btn-primary" >Create Split</button>
                                </form>
                            </div>
