                    ...
                    <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="container-fluid pt-4 px-4">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php 
                                            ...
                                            if(isset($_GET['term']))
                                            {
                                                ...
                                                $query = "SELECT * FROM user WHERE email LIKE '%$filtervalues%' ";
                                            ...
                                            foreach($query_run as $items)
                                            {
                                              ?>
                                                <form action="lending.php" method="post">
                                                    <tr>
                                                        <td ><input type="text" id="name1" name="name1" value="<?= $items['username']; ?>" style="border:0px" readonly></td>
                                                        <td ><input type="text" id="name2" name="name2" value="<?= $items['email']; ?>" style="border:0px" readonly></td>
                                                        <td ><input type="text" id="name3" name="name3"  style="border:0px"></td>
                                                        <input type="text" name="name4" value="<?= $upi; ?>" hidden>
                                ...
                                <a class="btn btn-sm btn-primary" href="splitting.php">Split Expense</a>
                            </div>
