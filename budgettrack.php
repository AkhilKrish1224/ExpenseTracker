        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="budget.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Budget Planning</a>
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Budget Progress</h6>
                            <?php
                                    $query = "SELECT sum(exp.amount) as amt,bgt.amount as mx,exp.category FROM `exp` join `bgt` on exp.category=bgt.category where bgt.email='$mail' group by category";
                                    ...
                                    if(mysqli_num_rows($query_run) != 0)
                                    {
                                        ...
                                        ?>
                                             <div class="pg-bar mb-3">
                                                <div class="progress">
                                                    <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow=<?= ($items['amt']/$items['mx'])*100; ?> aria-valuemin="0" aria-valuemax="100"><?= $items['category']," ₹",$items['amt'] ?></div>
                                                </div>
                                            </div>
                                        <?php
                                        }
