                ...
                <div class="row vh-75 bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <form action="exp.php" id="test" method="post">
                            <h3 class="mb-4">Expense</h3>
                            ...
                            <div class="form-floating mb-3">
                                <input type="date" class="form-control" id="floatingTenure"
                                    placeholder="Tenure" name="Date" required>
                                <label for="floatingTenure">Date</label>
                            </div>
