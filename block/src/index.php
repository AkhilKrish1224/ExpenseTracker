...
<body>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="index.php" class="nav-item nav-link"><i class="fa fa-tachometer-alt me-2"></i>Money Lending</a>
        ...
        <div class="content">
            ...
            <!-- <div class="container-fluid pt-4 px-4">
                <div class="row vh-100 bg-secondary rounded align-items-center justify-content-center mx-0">
                    ...
                    <div id="content">
                      <form onSubmit="App.addPeer(); return false;">
                ...
                <div class="row vh-75 bg-secondary rounded align-items-center justify-content-center mx-0">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="..\..\request.php" method="post" onclickonsubmit="copySpanContent()">
                                <input type="text" id="hiddeninput" name="hiddeninput" hidden>
                                <button type="submit" class="btn btn-primary">Request Money</button>
                            </form>
                            <form action="..\..\managerequests.php" method="post" onclickonsubmit="copySpanContent()">
                                <input type="text" id="hiddeninput" name="hiddeninput" hidden>
                                <button type="submit" class="btn btn-primary">Manage Request</button>
                            </form>
    ...
    <script type="text/javascript">
        function copySpanContent() {
            document.getElementById("hiddeninput").value = document.getElementById("account").firstChild.data;
